...
class MainTabBarController: UITabBarController {
    override func viewDidLoad() {
        ...
        self.setViewControllers([homeVC, workoutsVC, progressVC, nutritionVC, profileVC], animated: false)
        ...
        let attributes = [NSAttributedString.Key.font: UIFont(name: "Raleway-SemiBold", size: 12)]
